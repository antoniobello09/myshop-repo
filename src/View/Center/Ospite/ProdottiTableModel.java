 ...
 */
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex) {
            ...
            case 6: SchedaProdotto schedaProdotto = SchedaProdottoDAO.getInstance().findByShop_Product(p.getIdArticolo(), (Integer) SessionManager.getInstance().getSession().get("idPuntoVendita"));
