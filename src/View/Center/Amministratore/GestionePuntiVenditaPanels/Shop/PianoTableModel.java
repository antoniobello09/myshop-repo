...
public class PianoTableModel extends AbstractTableModel {

    private ArrayList<Piano> lista;
    private int selectedRow;
    private int editableRow = -1;

    public PianoTableModel(ArrayList<Piano> lista){
        this.lista = lista;
    }
    ...
    public void setLista(ArrayList<Piano> lista) {
        this.lista = lista;
    }
