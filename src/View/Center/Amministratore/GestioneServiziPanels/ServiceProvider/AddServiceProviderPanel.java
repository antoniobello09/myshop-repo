...
import View.Listener.Amministratore.GestioneServiziListener.ServiceProvider.AddServiceProviderListener;

import javax.swing.*;
import java.awt.*;

public class AddServiceProviderPanel extends JPanel {

    private AppFrame appFrame;
    private AddServiceProviderListener addServiceProviderListener;
    ...
    public AddServiceProviderPanel(AppFrame appFrame){

        this.appFrame = appFrame;
        addServiceProviderListener = new AddServiceProviderListener(this, this.appFrame);
    ...
    public void aggiungi(){
        if(!isFormOK()) return;
        FornitoreServizi fornitore = new FornitoreServizi();
        fornitore.setNome(nomeField.getText());
        fornitore.setSitoweb(sitowebField.getText());
        fornitore.setCitta(cittaField.getText());
        fornitore.setNazione(nazioneField.getText());
        FornitoreServiziDAO.getInstance().add(fornitore);
    ...
    public void listenerSettings(){
        btnAggiungi.addActionListener(addServiceProviderListener);
