...
public class SMGestioneSchedeProdotto extends JPanel {

    private JButton aggiungiServizio = new JButton("Schede Prodotti");
    ...
    public SMGestioneSchedeProdotto(AppFrame appFrame) {
