...
public class RegisterPanel extends JPanel {
    ...
    public boolean isIscrivitiOK(){
        if( usernameField.getText().equals("")|| passwordField.getText().equals("")||
                ...
                telefonoField.getText().equals("")||residenzaField.getText().equals("")||cittaField.getText().equals("")||professioneField.getText().equals("")){
    ...
    public void componentsAdding(){
        ...
        formRegistrazionePanel.add(inserisciCitta);
        formRegistrazionePanel.add(cittaField);
    ...
    public void clearFields(){
        ...
        residenzaField.setText("");
        cittaField.setText("");
        professioneField.setText("");
